...
public class Conversions {
   ...
   * @return velocity in m/s -> encoderTicks/s
   */
   ...
   * 
   * @param sensorCounts integrated encoder ticks
   * @return encoder ticks -> meters
   */
  public static double nativeUnitsToDistanceMeters(double sensorCounts) {
    if (gearRatio.getAsDouble() > 20) { // low gear
      ...
      return sensorCounts * DriveConstants.distancePerTickMetersHighGear;
  }
