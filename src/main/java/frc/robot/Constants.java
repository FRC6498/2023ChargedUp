...
public class Constants {
    public static final class DriveConstants {
        ...
        public static final double distancePerTickMetersLowGear =
        ...
        public static final DifferentialDriveFeedforward drivetrainFeedforward =
        ...
        public static final TrajectoryConfig trajectoryConfig =
                new TrajectoryConfig(2.4, 1.5).setKinematics(kinematics);
    ...
    public static final class VisionConstants {
        ...
        public static final AprilTagFieldLayout tagLayout = new AprilTagFieldLayout(List.of(
                // X axis = long axis, y axis = short axis
                // only need to measure X 2-3 times
                // Y needed for all tags
                // origin at near-right corner
                new AprilTag(1,
                        new Pose3d(Units.inchesToMeters(120.25 + 300), archeryWallY,
                                Units.inchesToMeters(23.75),
                                new Rotation3d(VecBuilder.fill(0, 0, 1),
                                        Units.degreesToRadians(270)))),
                // new AprilTag(2, new Pose3d(0, 0, Units.inchesToMeters(51.5), new
                // Rotation3d(VecBuilder.fill(0, 0, 1), Units.degreesToRadians(90)))),
                new AprilTag(3,
                ...
                new AprilTag(5,
                        new Pose3d(Units.inchesToMeters(208.125), archeryWallY,
                                Units.inchesToMeters(44),
                                new Rotation3d(VecBuilder.fill(0, 0, 1),
                                        Units.degreesToRadians(270)))),
                // new AprilTag(6, new Pose3d(0, 0, Units.inchesToMeters(57.0625), new
                // Rotation3d(VecBuilder.fill(0, 0, 1), Units.degreesToRadians(90)))),
                new AprilTag(7, new Pose3d(Units.inchesToMeters(30.5), archeryWallY,
